...
IotWebConfSelectParameter useHAmqttDiscoveryParam = IotWebConfSelectParameter("Enable HomeAssistant mqttDiscovery", "Enable HomeAssistant mqttDiscovery", useHAmqttDiscoveryValue, NUMBER_LEN, (char*)useHAmqttDiscoveryVal, (char*)useHAmqttDiscoveryNam, sizeof(useHAmqttDiscoveryNam) / NUMBER_LEN, NUMBER_LEN);
