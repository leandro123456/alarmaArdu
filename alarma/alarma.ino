...
const char wifiInitialApPassword[] = "12345678";//"wDJGtmE6Rj4Ft"; 
...
char isNewDeviceValue[NUMBER_LEN];
...
static char isNewDeviceVal[][NUMBER_LEN] = { "1", "0"};
static char isNewDeviceNam[][NUMBER_LEN] = { "Yes", "No"};
...
IotWebConfSelectParameter useHAmqttDiscoveryParam = IotWebConfSelectParameter("Use HomeAssistant mqttDiscovery?", "Use HomeAssistant mqttDiscovery", useHAmqttDiscoveryValue, NUMBER_LEN, (char*)useHAmqttDiscoveryVal, (char*)useHAmqttDiscoveryNam, sizeof(useHAmqttDiscoveryNam) / NUMBER_LEN, NUMBER_LEN);
IotWebConfTextParameter defaultHAPrefixParam = IotWebConfTextParameter("Default mqttDiscovery prefix", "Default mqttDiscovery prefix", defaultHAPrefixValue, STRING_LEN, "homeassistant", "homeassistant", "homeassistant");
IotWebConfSelectParameter isNewDeviceParam = IotWebConfSelectParameter("is New Device?", "is New Device", isNewDeviceValue, NUMBER_LEN, (char*)isNewDeviceVal, (char*)isNewDeviceNam, sizeof(isNewDeviceNam) / NUMBER_LEN, NUMBER_LEN);
...
static char mqttRetNam[][NUMBER_LEN] = { "0", "1"};
...
void setup() {
  ...
  group1.addItem(&useHAmqttDiscoveryParam);
  group1.addItem(&defaultHAPrefixParam);
  group1.addItem(&isNewDeviceParam);
