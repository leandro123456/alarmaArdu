...
void wifiConnected(){
    ...
    Serial.println("UPDATEFIRMAWARE1: "+String(remoteUpateFirmware));
    if(String(remoteUpateFirmware).equals("1")){
      memset(remoteUpateFirmware, 0, sizeof remoteUpateFirmware);
      strncpy(remoteUpateFirmware, String(0).c_str(), String(0).length());
